...
- [X] Mention two parts of Express that you learned about this week.
    ...
    1) Express allows us to write custom middleware for our APIs.
    2) Express enables server-side routing so you break down different request handlers for more DRY, modular, readable code.

- [X] Describe Middleware?

    Middleware is a tool to intercept some process, run a function, and then continue the process.  In essense, it's a function that enables programmers to work with data flowing between the request and the response.

- [X] Describe a Resource?

    Resources are anything that can be accessed by a URL using HTTP.  They are data available from the backend.

- [X] What can the API return to help clients know if a request was successful?

    Any status using 200.

- [X] How can we partition our application into sub-applications?

    Through routing we can set up different endpoints for different files.
